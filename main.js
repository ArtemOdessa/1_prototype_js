...
console.log("Рейтинг посещаемости студента " + st1.name + ": " + group.attendance('Shvets'));
console.log("Рейтинг посещаемости студента " + st2.name + ": " + group.attendance('Shves'));
console.log("Средняя посещаемость группы: " + group.attendance());
console.log("Рейтинг по оценкам студента " + st1.name + ": " + group.performance('Shvets'));
console.log("Рейтинг по оценкам студента " + st2.name + ": " + group.performance('Shves'));
console.log("Средняя оценка группы: " + group.performance());